...
from read_data import CheXpertDataSet

use_gpu = torch.cuda.is_available()

#CKPT_PATH = 'model.pth.tar'
#N_CLASSES = 14
#DATA_DIR = './CheXpert-v1.0-small/train'
#TEST_IMAGE_LIST = '../CheXpert-v1.0-small/train.csv'
#BATCH_SIZE = 64
...
class CheXpertTrainer():
    ...
    def train (pathDirData, pathFileTrain, pathFileVal, nnArchitecture, nnIsTrained, nnClassCount, 
        ...
        datasetTrain = CheXpertDataSet(pathDirData, pathFileTrain,transformSequence)
        datasetVal =   CheXpertDataSet(pathDirData, pathFileVal, transformSequence)
              
        dataLoaderTrain = DataLoader(dataset=datasetTrain, batch_size=trBatchSize, shuffle=True,  num_workers=24, pin_memory=True)
        dataLoaderVal = DataLoader(dataset=datasetTrainn, batch_size=trBatchSize, shuffle=False, num_workers=24, pin_memory=True)
    ...
    def test (pathDirData, pathFileTest, pathModel, nnArchitecture, nnClassCount, nnIsTrained, trBatchSize, transResize, transCrop, launchTimeStamp):   
        ...
        datasetTest = CheXpertDataSet(pathImageDirectory=pathDirData, pathDatasetFile=pathFileTest, transform=transformSequence)
